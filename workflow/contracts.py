...
class WorkflowErrorCode(StrEnum):
    ...
    VISION_OUTPUT_INCOMPLETE = "VISION_OUTPUT_INCOMPLETE"
    INVALID_VISION_PAYLOAD = "INVALID_VISION_PAYLOAD"
    ...
    SPRINT_OWNER_UNAVAILABLE = "SPRINT_OWNER_UNAVAILABLE"
    SPRINT_OWNER_CONFLICT = "SPRINT_OWNER_CONFLICT"
