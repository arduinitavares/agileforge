...
_PHASE_2B_COMMANDS: tuple[CommandMetadata, ...] = (
    CommandMetadata(
        ...
        input_required=("name", "greenfield_spec_amendment_draft_id"),
        input_optional=(
            "idempotency_key",
            "dry_run",
            "dry_run_id",
        ...
        errors=(
            ...
            ErrorCode.GREENFIELD_DISCOVERY_REQUIRED.value,
            ErrorCode.GREENFIELD_DISCOVERY_NOT_FOUND.value,
            ErrorCode.GREENFIELD_SPEC_AMENDMENT_NOT_ACCEPTED.value,
    ...
    CommandMetadata(
        ...
        errors=(
            ...
            ErrorCode.COMPILED_AUTHORITY_INVALID.value,
...
_PHASE_2D_COMMANDS: tuple[CommandMetadata, ...] = (
    ...
    CommandMetadata(
        name="agileforge story repair-completion-scope",
        mutates=True,
        phase="phase_2d",
        requires_idempotency_key=True,
        input_required=(
...
_SCOPE_DISCOVERY_COMMANDS: tuple[CommandMetadata, ...] = (
    ...
    CommandMetadata(
        ...
        input_optional=("supersedes_prd_id", "changed_by"),
        errors=(
            ErrorCode.PROJECT_NOT_FOUND.value,
    ...
    CommandMetadata(
        name="agileforge discovery prd accept",
        mutates=True,
        phase="scope_discovery",
        requires_idempotency_key=True,
        idempotency_policy=_REQUIRED_IDEMPOTENCY_POLICY,
    ...
    CommandMetadata(
        name="agileforge discovery prd reject",
        mutates=True,
        phase="scope_discovery",
        requires_idempotency_key=True,
        idempotency_policy=_REQUIRED_IDEMPOTENCY_POLICY,
    ...
    CommandMetadata(
        name="agileforge discovery greenfield challenge record",
        mutates=True,
        phase="scope_discovery",
        requires_idempotency_key=True,
        idempotency_policy=_REQUIRED_IDEMPOTENCY_POLICY,
        input_required=("context_key", "artifact_file", "idempotency_key"),
        input_optional=("changed_by",),
        errors=(
            ErrorCode.CHALLENGE_ARTIFACT_FILE_NOT_FOUND.value,
            ErrorCode.CHALLENGE_ARTIFACT_INVALID.value,
    ...
    CommandMetadata(
        name="agileforge discovery greenfield prd draft record",
        mutates=True,
        phase="scope_discovery",
        requires_idempotency_key=True,
        idempotency_policy=_REQUIRED_IDEMPOTENCY_POLICY,
    ...
    CommandMetadata(
        name="agileforge discovery greenfield prd accept",
        mutates=True,
        phase="scope_discovery",
        requires_idempotency_key=True,
        idempotency_policy=_REQUIRED_IDEMPOTENCY_POLICY,
    ...
    CommandMetadata(
        name="agileforge discovery greenfield prd reject",
        mutates=True,
        phase="scope_discovery",
        requires_idempotency_key=True,
        idempotency_policy=_REQUIRED_IDEMPOTENCY_POLICY,
    ...
    CommandMetadata(
        name="agileforge discovery greenfield spec-amendment draft record",
        mutates=True,
        phase="scope_discovery",
        requires_idempotency_key=True,
        idempotency_policy=_REQUIRED_IDEMPOTENCY_POLICY,
    ...
    CommandMetadata(
        name="agileforge discovery greenfield spec-amendment accept",
        mutates=True,
        phase="scope_discovery",
        requires_idempotency_key=True,
        idempotency_policy=_REQUIRED_IDEMPOTENCY_POLICY,
    ...
    CommandMetadata(
        name="agileforge discovery greenfield spec-amendment reject",
        mutates=True,
        phase="scope_discovery",
        requires_idempotency_key=True,
        idempotency_policy=_REQUIRED_IDEMPOTENCY_POLICY,
