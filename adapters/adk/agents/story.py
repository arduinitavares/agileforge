...
async def preserve_story_output_schema(
    callback_context: CallbackContext,
    llm_request: LlmRequest,
) -> LlmResponse | None:
    """Request strict structured output while preserving raw field presence."""
    del callback_context
    llm_request.set_output_schema(UserStoryWriterOutput)
    return None
...
def create_user_story_writer_agent() -> Agent:
    ...
    return Agent(
        ...
        before_model_callback=preserve_story_output_schema,
